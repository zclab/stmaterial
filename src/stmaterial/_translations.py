...
def convert_json(folder=None):
    ...
    out_folder = folder / ".." / ".." / "theme" / "stmaterial" / "static"
...
"""
    ...
    # compile mo
    for path in (out_folder / "locales").glob("**/stmaterial.po"):
        print(path)
        subprocess.check_call(
            [
                ...
                "-o",
                os.path.abspath(path.parent / "stmaterial.mo"),
            ]
        )
